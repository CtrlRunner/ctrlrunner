...
built with Vite into src/ctrlrunner/reporting/_static/report/index.html as a
...
`window.__CTRLRUNNER_REPORT__ = {...}` script -- the same data contract
...
def render_html(
    ...
    return page.replace(
        _DATA_MARKER,
        f"<script>window.__CTRLRUNNER_REPORT__ = {data_json};</script>",
        1,
    )
