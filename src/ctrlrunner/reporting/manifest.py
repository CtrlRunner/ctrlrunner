...
next to results.json -- ctrlrunner/Python versions, the resolved run
...
def _ctrlrunner_version() -> str:
    try:
        return version("ctrlrunner")
...
def build_manifest(
    *,
    ...
    return {
        "ctrlrunnerVersion": _ctrlrunner_version(),
