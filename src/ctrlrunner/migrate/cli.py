"""CLI: python -m ctrlrunner.migrate <paths> [--write] [--no-diff] [--report FILE]"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m ctrlrunner.migrate",
        description="Migrate pytest test suites to ctrlrunner. Dry-run by "
