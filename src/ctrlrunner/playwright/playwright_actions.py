...
recorded as ctrlrunner steps -- mirroring Playwright TS's built-in
...
ctrlrunner's core package doesn't gain a hard dependency on Playwright --
...
def auto_step(target):
    ...
    automatically recorded as ctrlrunner steps."""
