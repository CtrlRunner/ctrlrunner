...
built with Vite into pyrunner/ui/_static/ui/ui.html as ONE self-contained
...
_TOKEN_PLACEHOLDER = "__PYRUNNER_SESSION_TOKEN__"
...
def render_ui_html(token: str) -> str:
    ...
    can't forge the X-Pyrunner-Token header the state-changing POST
    endpoints require."""
    page = resources.files("pyrunner.ui").joinpath("_static/ui/ui.html").read_text(encoding="utf-8")
