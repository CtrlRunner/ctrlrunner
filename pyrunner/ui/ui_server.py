...
# (`pyrunner-artifacts/<test>/attempt-N/...`, relative to the process's
...
ARTIFACTS_ROOT = Path("pyrunner-artifacts").resolve()
...
class UIRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path in ("/", "/index.html"):
            ...
            self._stream_events()
        elif self.path.startswith("/pyrunner-artifacts/"):
    ...
    def _serve_artifact(self):
        ...
        links to (`<a href="pyrunner-artifacts/...">`) -- without this,
        ...
        relative = url_path[len("/pyrunner-artifacts/") :]
...
def serve_ui(
    ...
    if block:
        print(f"pyrunner UI Mode at {url}")
